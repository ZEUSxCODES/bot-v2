...
import os
req_channel = int(os.environ.get('REQ_CHANNEL','-1001886441345'))
    ...
    if not spoll:
        ...
        if 2 < len(message.text) < 100:
            ...
            if not files:
                ...
                await message.reply_text(text=f"Hello '{message.from_user.first_name}' 😊. \n\n Your request has been sent to your admin ! \n\n ❤️ THANK YOU ❤️", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('Request Status', url=f'https://t.me/Request_Log')]]))
